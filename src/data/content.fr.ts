...
export const fr: Content = {
  meta: {
    title: 'Alexis Fievet — Portfolio · Infrastructures, Réseaux & Cybersécurité',
    description:
      'Alexis Fievet, alternant technicien IT chez NOOUS, en Bachelor Infrastructures Réseaux & Cybersécurité. Recherche une alternance en Master Cybersécurité / Informatique — rentrée septembre 2027.',
    ogLocale: 'fr_FR',
  },
  ui: {
    skip: 'Aller au contenu',
    homeAria: 'Alexis Fievet — haut de page',
    ...
    kicker: 'Portfolio',
    badge: "À la recherche d'une alternance",
    heroMeta: {
      seeking: 'Recherche',
      seekingVal: 'Master Cybersécurité / Informatique',
      start: 'Rentrée',
      startVal: 'Septembre 2027',
      base: 'Base',
    },
    ctaProjects: 'Voir mes projets',
    ctaCv: 'Télécharger mon CV',
    photoAlt: 'Portrait d’Alexis Fievet',
    about: {
      label: 'Profile',
      title: 'À propos',
      asideAria: 'Qualités et informations',
      bring: "Ce que j'apporte",
      languages: 'Langues',
      offscreen: 'Hors écran',
    },
    experience: { label: 'Experience', title: 'Expérience', tagsAria: 'Technologies et compétences' },
    projects: { label: 'Projects', title: 'Projets', goal: 'Objectif', done: 'Réalisé', stackAria: 'Stack' },
    skills: { label: 'Skills', title: 'Compétences', education: 'Formation' },
    contact: {
      label: 'Contact',
      lines: ['Un projet ?', 'Une alternance ?', 'Parlons-en.'],
      button: 'Me contacter',
      cvLink: 'CV (PDF)',
    },
  ...
  skills: [
    ...
    { title: 'Documentation', items: ['Procédures', 'Documentation technique'] },
  ],
  education: [
    {
